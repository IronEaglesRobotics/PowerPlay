...
//        Pose2d start3 = new Pose2d(-22,14,Math.toRadians(0));
        Pose2d start4 = new Pose2d(28,5,Math.toRadians(-135));
        ...
        Pose2d lLoad1 = new Pose2d(59,11.5,Math.toRadians(180));
...
//        Pose2d sPark1 = new Pose2d(-10,21, Math.toRadians(-90));
        Pose2d sPark1 = new Pose2d(49, 14.0, Math.toRadians(180));
        Pose2d s2Park1 = new Pose2d(54, 25, Math.toRadians(-90));
        Pose2d lPark1 = new Pose2d(54,28,Math.toRadians(-90));
