...
public class RightSafeAuto extends AbstractAuto {
    ...
    public double maxVel = 72;
    public double maxAcc = 45;
    ...
    public void makeTrajectories() {
        ...
        Pose2d start4 = new Pose2d(-6.0,18,Math.toRadians(45));
        ...
        Pose2d sScore1 = new Pose2d(-4.5,17.5,Math.toRadians(45));
        ...
        Pose2d lPark1 = new Pose2d(-6,17, Math.toRadians(0));
