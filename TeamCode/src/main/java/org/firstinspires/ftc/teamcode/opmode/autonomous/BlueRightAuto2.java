...
//        Robot robot = new Robot(hardwareMap);
        ...
        Pose2d score = new Pose2d(-32,10,Math.toRadians(135));
        Pose2d load = new Pose2d(-61,15,Math.toRadians(180));
        ...
        Trajectory fromScoreToLoad = drive.trajectoryBuilder(score)
                .splineToSplineHeading(new Pose2d(-48,15,Math.toRadians(180)),Math.toRadians(180))
                .lineToSplineHeading(new Pose2d(-61,15,Math.toRadians(180)))
                .build();
        Trajectory fromLoadToScore = drive.trajectoryBuilder(load)
                .lineToSplineHeading(new Pose2d(-48,15,Math.toRadians(180)))
                .splineToSplineHeading(new Pose2d(-32,10,Math.toRadians(135)),Math.toRadians(-45))
                .build();
