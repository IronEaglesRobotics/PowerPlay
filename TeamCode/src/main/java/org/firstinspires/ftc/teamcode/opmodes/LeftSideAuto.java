...
public class LeftSideAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory getCone = drive.trajectoryBuilder(prepareForDunk.end())
                .splineTo(new Vector2d(-36.00001, -13), Math.toRadians(180))
                .splineTo(new Vector2d(-51.5, -13), Math.toRadians(186))
                .build();

        Trajectory scoreAgain = drive.trajectoryBuilder(getCone.end(), true)
                .lineToSplineHeading(new Pose2d(-40, -13, Math.toRadians(180)))
                .lineToSplineHeading(new Pose2d(-35, -13, Math.toRadians(135)))
                .build();
        ...
        Trajectory getAgain2 = drive.trajectoryBuilder(scoreAgain.end())
                .splineTo(new Vector2d(-36.00001, -13), Math.toRadians(180))
                .splineTo(new Vector2d(-51.2, -13), Math.toRadians(186))
                .build();

        Trajectory park1 = drive.trajectoryBuilder(scoreAgain.end())
                .splineTo(new Vector2d(-37.00001, -12), Math.toRadians(180))
