...
public class LeftCarryAuto extends AbstractAuto {
    ...
    public void makeTrajectories() {
        ...
        Pose2d sLoad3 = new Pose2d(48, 12-1.0, Math.toRadians(0));
        Pose2d sLoad4 = new Pose2d(48, 12-1.5, Math.toRadians(0));
        Pose2d sLoad5 = new Pose2d(48, 12-2.0, Math.toRadians(0));
        Pose2d lLoad1 = new Pose2d(63.5,12-0.0,Math.toRadians(0));
        Pose2d lLoad2 = new Pose2d(63.5,12-0.5,Math.toRadians(0));
        Pose2d lLoad3 = new Pose2d(63.5,12-1.0,Math.toRadians(0));
        Pose2d lLoad4 = new Pose2d(63.5,12-1.5,Math.toRadians(0));
        Pose2d lLoad5 = new Pose2d(63.5,12-2.0,Math.toRadians(0));

        Pose2d lScore1 = new Pose2d(48,12-0.0,Math.toRadians(0));
        Pose2d lScore2 = new Pose2d(48,12-0.5,Math.toRadians(0));
...
//        Pose2d sPark2 = new Pose2d(-36,24, Math.toRadians(90));
        ...
        startScore = robot.drive.trajectoryBuilder(start)
                ...
                .addTemporalMarker(0, () -> robot.claw.close())
                .addTemporalMarker(0.1, () -> robot.slides.setTarget(Slides.Position.HIGH))
                .addTemporalMarker(1.5, () -> robot.arm.goToScore())
                .build();
