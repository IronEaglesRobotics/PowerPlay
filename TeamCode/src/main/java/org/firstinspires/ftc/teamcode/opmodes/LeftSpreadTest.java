...
@Config
@Autonomous(name = "LeftSpreadTest", group = "Competition", preselectTeleOp = "MainTeleOp")
public class LeftSpreadTest extends AutoBaseSpread {
...
//High
        this.scoreStackConeHigh = this.robot.getDrive().trajectoryBuilder(getStackConePreload.end())
                .lineToSplineHeading(new Pose2d(-55, -8, Math.toRadians(170)))
                .splineTo(new Vector2d(-3,-13),Math.toRadians(-39))
