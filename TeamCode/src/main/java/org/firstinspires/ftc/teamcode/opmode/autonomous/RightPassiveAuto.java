...
public class RightPassiveAuto extends AbstractAuto {
    ...
    public void makeTrajectories() {
        ...
        Pose2d score = new Pose2d(-27.5,20.0,Math.toRadians(25));

        Pose2d sLoad1 = new Pose2d(-50,y1,Math.toRadians(0));
        Pose2d sLoad2 = new Pose2d(-49,y2,Math.toRadians(0));
        Pose2d sLoad3 = new Pose2d(-48,y3,Math.toRadians(0));
        Pose2d sLoad4 = new Pose2d(-47,y4,Math.toRadians(0));
        Pose2d sLoad5 = new Pose2d(-46,y5,Math.toRadians(0));
        Pose2d lLoad1 = new Pose2d(-56.0,y1,Math.toRadians(0));
        Pose2d lLoad2 = new Pose2d(-55.5,y2,Math.toRadians(0));
        Pose2d lLoad3 = new Pose2d(-55.0,y3,Math.toRadians(0));
        Pose2d lLoad4 = new Pose2d(-54.5,y4,Math.toRadians(0));
        Pose2d lLoad5 = new Pose2d(-54.0,y5,Math.toRadians(0));

        Pose2d lScore1 = new Pose2d(-50,y1,Math.toRadians(0));
        Pose2d lScore2 = new Pose2d(-49,y2,Math.toRadians(0));
        Pose2d lScore3 = new Pose2d(-48,y3,Math.toRadians(0));
        Pose2d lScore4 = new Pose2d(-47,y4,Math.toRadians(0));
        Pose2d lScore5 = new Pose2d(-46,y5,Math.toRadians(0));
        Pose2d sScore1 = new Pose2d(-27.5,19.5,Math.toRadians(45));
        Pose2d sScore2 = new Pose2d(-26.5,19.0,Math.toRadians(45));
        Pose2d sScore3 = new Pose2d(-25.0,18.5,Math.toRadians(45));
        Pose2d sScore4 = new Pose2d(-23.5,18.0,Math.toRadians(45));
        Pose2d sScore5 = new Pose2d(-22.0,17.5,Math.toRadians(45));

        Pose2d lPark1 = new Pose2d(-7,11, Math.toRadians(90));

        Pose2d lPark2 = new Pose2d(-34,12, Math.toRadians(90));

        Pose2d sPark3 = new Pose2d(-46, 9, Math.toRadians(0));
        Pose2d lPark3 = new Pose2d(-55,9,Math.toRadians(0));
